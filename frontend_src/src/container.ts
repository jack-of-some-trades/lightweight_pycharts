...
import { Container, layout_display } from "../components/layout/container"
...
export class container{
    ...
    setDisplay: SetStoreFunction<layout_display[]>
    ...
    constructor(
        ...
        //tbh i can't get either a Store or Signal of flex_frames to be reactive on a resize..
        //This solution is just going to be a lot easier.
        this.style = document.createElement('style')
        this.div.appendChild(this.style)

        const [display, setDisplay] = createStore<layout_display[]>([])
        this.setDisplay = setDisplay

        //Merge the Vanilla JS back into the Solid-JS Framework
        const container_props = { displays: display }
