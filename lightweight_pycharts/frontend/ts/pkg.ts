/* Altered verserion of index.d.ts from the lightweight chart library (v4.1.3). See Comment on index.ts for more info. */

// Generated by dts-bundle-generator v8.0.1

//import { CanvasRenderingTarget2D } from 'fancy-canvas';
//This spoofs the type declaration so the fancy-canvas .d.ts, and the headache it brings, isn't needed.
declare type CanvasRenderingTarget2D = 'canvas'
...
//This section is all the functions that are exported in ../js/pkg.mjs
